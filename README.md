...
The code consists of functions for:
  1. Taking and storing user input
  2. Performing Hungarian Algorithm: divided into 5 main sections containing the 5 steps of the algorithm and some of these steps also consists of multiple functions
